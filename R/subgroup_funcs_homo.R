#' @description Estimates parameters of a homoscedastic finite mixture with covariates
#' of regressions by the method of maximum likelhood.
#' @export
#' @title subgroupMLE_homo
#' @name subgroupMLE_homo
...
#' @export
#' @title subgroupMLEinit_homo
#' @name subgroupMLEinit_homo
#' @param y n by 1 vector of data for y.
#' @param x n by q1 matrix of data for x.
...
}  # end function subgroupMLEinit_homo
